  ...
  return (
    <div className={cls.root}>
      ...
      <div className={cls.contact_container}>
        ...
        <ul>
          <li>
            <Link to="https://github.com/bainur-5">
              <GitIcon className={cls.contact_icon} />
            </Link>
          </li>
          <li>
            <Link to="https://t.me/BainurAB">
              <TelegramIcon className={cls.contact_icon} />
            </Link>
          </li>
          <li>
            <Link to="https://bainur05ab@gmail.com">
              <GmailIcon className={cls.contact_icon} />
            </Link>
          </li>
          <li>
            <Link to="https://www.linkedin.com/in/bainur-absamatov-836746280?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3B%2BiyD05dRRtqNHaDGsU8PtA%3D%3D">
